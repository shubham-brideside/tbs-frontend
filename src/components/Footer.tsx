    ...
    <footer className="border-t bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        ...
        <div className="mb-6 md:mb-8">
          <h3 className="text-xl md:text-2xl font-bold text-gray-600 mb-4 md:mb-6">Contact Us</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="space-y-4 md:space-y-6">
              {/* Wedding Curation */}
              <div>
                <h4 className="text-sm font-bold text-gray-800 mb-1.5">For Wedding Curation</h4>
              ...
              {/* Address */}
              <div>
                <h4 className="text-sm font-bold text-gray-800 mb-1.5">Our Address</h4>
            ...
            <div className="space-y-4 md:space-y-6">
              {/* Customer Services */}
              <div>
                <h4 className="text-sm font-bold text-gray-800 mb-1.5">For Customer Services</h4>
                <div className="flex items-center space-x-2">
              ...
              {/* WhatsApp Contact */}
              <div>
                <h4 className="text-sm font-bold text-gray-800 mb-1.5">WhatsApp</h4>
                <div className="flex items-center space-x-2">
                  <svg className="w-4 h-4 text-black" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-3 md:space-y-4">
                ...
                <div className="flex items-center space-x-3 md:space-x-4">
                  <a 
                    ...
                    className="bg-black text-white px-2.5 py-1.5 md:px-3 md:py-1.5 rounded-full hover:bg-gray-800 transition-all duration-300 flex items-center space-x-2"
        ...
        <div className="border-t pt-4 md:pt-5">
          <p className="text-xs md:text-sm text-gray-800">© {new Date(new Date().toLocaleString('en-US', { timeZone: 'Asia/Kolkata' })).getFullYear()} TheBrideSide.in. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
